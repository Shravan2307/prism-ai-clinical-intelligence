...
class PatientRequest(BaseModel):
    ...
    bmi: StrictFloat = Field(ge=15.0, le=60.0)
    hba1c: StrictFloat = Field(ge=4.0, le=15.0)
    fasting_glucose: StrictFloat = Field(ge=50.0, le=350.0)
    egfr: StrictFloat = Field(ge=15.0, le=150.0)
    systolic_bp: StrictFloat = Field(ge=90.0, le=220.0)
    diastolic_bp: StrictFloat = Field(ge=50.0, le=130.0)
